...
function g_tooltip.init()
  ...
  addEvent(function()
    ...
    -- UILabel cru, sem estilo: sem fonte declarada ele cai no default (Verdana) e
    -- o tooltip vira o unico texto do cliente fora da skin. O fundo vai para a
    -- sombra de painel da paleta, mantendo a mesma transparencia.
    toolTipLabel:setFont('silkscreen-16')
    toolTipLabel:setColor('#150e0c')
    toolTipLabel:setBackgroundColor('#c68f66')
...
function g_tooltip.display(widget)
  ...
  toolTipLabel:setFont((widget.tooltipFont and widget.tooltipFont or "silkscreen-16"))
